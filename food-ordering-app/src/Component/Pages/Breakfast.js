            ...
            <div className='Filter'>
                ...
                <div className='DivCuisine DivCuisineAndCost'>
                    ...
                    <div className='RadCuisine RadCuisineAndCost'>
                        <div><input type='radio' name='Cuisine' id='NorthIndian' value='NorthIndian' /><label htmlFor='NorthIndian'>North Indian</label></div>
                        <div><input type='radio' name='Cuisine' id='SouthIndian' value='SouthIndian' /><label htmlFor='SouthIndian'>South Indian</label></div>
                        <div><input type='radio' name='Cuisine' id='Chinese' value='Chinese' /><label htmlFor='Chinese'>Chinese</label></div>
                        <div><input type='radio' name='Cuisine' id='FastFood' value='FastFood' /><label htmlFor='FastFood'>Fast Food</label></div>
                        <div><input type='radio' name='Cuisine' id='StreetFood' value='StreetFood' /><label htmlFor='StreetFood'>Street Food</label></div>
                    </div >
                </div>
                {/* Cost For two */}
